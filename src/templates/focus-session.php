<?php require_once __DIR__ . '/../core/config.php'; ?>
    ...
    <body>
<div class="container">
        <a href="uploading-material.php" class="back-link">Back to Upload Study Material</a>
        <div class="main-layout">
            <div class="sidebar">
                <div class="card" id="materials-card">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                        <span class="card-label">MATERIALS</span>
                        <a href="uploading-material.php" style="font-size: 12px; color: var(--primary-color); text-decoration: none;">+ Add</a>
                    </div>
