    ...
    <body>
      <div class="results-card">
        ...
        <div class="res-footer">
          <button
            class="btn-dashboard"
            onclick="window.location.href = '<?= TEMPLATES_URL ?>/study-session.php'"
          >
            Back to Dashboard
          </button>
          <button class="btn-restart" onclick="window.location.href = '<?= TEMPLATES_URL ?>/uploading-material.php'">
