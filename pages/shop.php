        ...
        <div class="product-grid">
          <div class="product-card">
            <div class="prod-img-wrap">
              ...
              >
              <img src="../assets/img/HT/1_0001s_0000_Layer-46.png" alt="T-Shirt H" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              ...
              >
              <img src="../assets/img/ST/1_0006s_0000_Layer-31.png" alt="T-Shirt S" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              ...
              >
              <img src="../assets/img/ZT/1_0011s_0000_Layer-9.png" alt="T-Shirt Z" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/BT/11_0002s_0000_Layer-63.png" alt="T-Shirt B" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/RT/111_0001s_0000_Layer-71.png" alt="T-Shirt R" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/KT/11_0001s_0000_Layer-83.png" alt="T-Shirt K" />
            </div>
            <div class="prod-body">
        ...
        <div class="product-grid">
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-hot"
                ><i data-lucide="flame"></i> Best Seller</span
              >
              <img src="../assets/img/HF/1_0002s_0000_Layer-42.png" alt="Flask H" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/SF/1_0007s_0000_Layer-27.png" alt="Flask S" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              ...
              >
              <img src="../assets/img/ZF/1_0010s_0000_Layer-21.png" alt="Flask Z" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/BF/11_0004s_0000_Layer-57.png" alt="Flask B" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/RF/111_0002s_0000_Layer-69.png" alt="Flask R" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/KF/11_0002s_0000_Layer-79.png" alt="Flask K" />
            </div>
            <div class="prod-body">
        ...
        <div class="product-grid">
          <div class="product-card">
            <div class="prod-img-wrap">
              ...
              >
              <img src="../assets/img/HTB/1_0000s_0000_Layer-49.png" alt="Tote Bag H" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/STB/1_0005s_0000_Layer-34.png" alt="Tote Bag S" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/BTB/11_0003s_0000_Layer-59.png" alt="Tote Bag B" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/RTB/111_0000s_0000_Layer-74.png" alt="Tote Bag R" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/KTB/11_0000s_0000_Layer-86.png" alt="Tote Bag K" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-hot"
                ><i data-lucide="flame"></i> Best Seller</span
              >
              <img src="../assets/img/ZS/1_0008s_0000_Layer-16.png" alt="Sticker Z" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-hot"
                ><i data-lucide="flame"></i> Best Seller</span
              >
              <img src="../assets/img/SB/1_0003s_0000_Layer-39.png" alt="Notebook S" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/ZB/1_0009s_0000_Layer-3.png" alt="Notebook Z" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/BB/11_0001s_0000_Layer-53.png" alt="Notebook B" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/RB/111_0003s_0000_Layer-66.png" alt="Notebook R" />
            </div>
            <div class="prod-body">
          ...
          <div class="product-card">
            <div class="prod-img-wrap">
              <span class="prod-badge badge-new"
                ><i data-lucide="sparkles"></i> New</span
              >
              <img src="../assets/img/KB/11_0003s_0000_Layer-76.png" alt="Notebook K" />
            </div>
            <div class="prod-body">
