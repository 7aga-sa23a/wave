INSERT INTO users (name, email, password, streak, max_streak, points, last_week_points, sessions, achievements, achievements_points, created_at)
SELECT
    CONCAT('User', n),
    CONCAT('user', n, '@example.com'),
    CONCAT('pass', FLOOR(RAND()*9999)),
    FLOOR(RAND()*15),
    FLOOR(5 + RAND()*25),
    FLOOR(100 + RAND()*5000),
    FLOOR(RAND()*2000),
    ...
    FLOOR(RAND()*20),
    FLOOR(RAND()*1000),
    NOW() - INTERVAL FLOOR(RAND()*10) DAY - INTERVAL FLOOR(RAND()*24) HOUR - INTERVAL FLOOR(RAND()*60) MINUTE - INTERVAL FLOOR(RAND()*60) SECOND
FROM (
...
INSERT INTO sessions (user_id, length, date)
SELECT
    FLOOR(1 + RAND()*20),
    SEC_TO_TIME(FLOOR(600 + RAND()*7200)),
    NOW() - INTERVAL FLOOR(RAND()*10) DAY - INTERVAL FLOOR(RAND()*24) HOUR - INTERVAL FLOOR(RAND()*60) MINUTE - INTERVAL FLOOR(RAND()*60) SECOND
FROM (
...
INSERT INTO quizzes (user_id, score, length, answered_questions, total_questions, date)
SELECT
    FLOOR(1 + RAND()*20),
    FLOOR(50 + RAND()*50),
    SEC_TO_TIME(FLOOR(300 + RAND()*2400)),
    FLOOR(5 + RAND()*16),
    20,
    NOW() - INTERVAL FLOOR(RAND()*10) DAY - INTERVAL FLOOR(RAND()*24) HOUR - INTERVAL FLOOR(RAND()*60) MINUTE - INTERVAL FLOOR(RAND()*60) SECOND
FROM (
