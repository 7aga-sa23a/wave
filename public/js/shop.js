const _IMG_URL = window.APP_PATHS?.IMG_URL || '../../public/assets/img';
const PRODUCTS = {
        "T-Shirt — H": {
          cat: "T-Shirts",
          price: "199 EGP",
          ...
          images: [
            `${_IMG_URL}/HT/1_0001s_0000_Layer-46.png`,
            `${_IMG_URL}/HT/1_0001s_0001_Layer-47.png`,
          ],
        },
        "T-Shirt — S": {
          cat: "T-Shirts",
          ...
          images: [
            `${_IMG_URL}/ST/1_0006s_0000_Layer-31.png`,
            `${_IMG_URL}/ST/1_0006s_0001_Layer-32.png`,
          ],
        },
        "T-Shirt — Z": {
          cat: "T-Shirts",
          ...
          images: [
            `${_IMG_URL}/ZT/1_0011s_0000_Layer-9.png`,
            `${_IMG_URL}/ZT/1_0011s_0001_Layer-10.png`,
            `${_IMG_URL}/ZT/1_0011s_0002_Layer-11.png`,
            `${_IMG_URL}/ZT/1_0011s_0003_Layer-12.png`,
            `${_IMG_URL}/ZT/1_0011s_0004_Layer-13.png`,
            `${_IMG_URL}/ZT/1_0011s_0005_Layer-14.png`,
          ],
        },
        "Stainless Flask — H": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/HF/1_0002s_0000_Layer-42.png`,
            `${_IMG_URL}/HF/1_0002s_0001_Layer-43.png`,
            `${_IMG_URL}/HF/1_0002s_0002_Layer-44.png`,
          ],
        },
        "Stainless Flask — S": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/SF/1_0007s_0000_Layer-27.png`,
            `${_IMG_URL}/SF/1_0007s_0001_Layer-28.png`,
            `${_IMG_URL}/SF/1_0007s_0002_Layer-29.png`,
          ],
        },
        "Stainless Flask — Z": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/ZF/1_0010s_0000_Layer-21.png`,
            `${_IMG_URL}/ZF/1_0010s_0001_Layer-22.png`,
            `${_IMG_URL}/ZF/1_0010s_0002_Layer-23.png`,
            `${_IMG_URL}/ZF/1_0010s_0003_Layer-24.png`,
            `${_IMG_URL}/ZF/1_0010s_0004_Layer-25.png`,
          ],
        },
        "Tote Bag — H": {
          cat: "Tote Bags",
          ...
          images: [
            `${_IMG_URL}/HTB/1_0000s_0000_Layer-49.png`,
            `${_IMG_URL}/HTB/1_0000s_0001_Layer-51.png`,
          ],
        },
        "Tote Bag — S": {
          cat: "Tote Bags",
          ...
          images: [
            `${_IMG_URL}/STB/1_0005s_0000_Layer-34.png`,
            `${_IMG_URL}/STB/1_0005s_0001_Layer-35.png`,
          ],
        },
        "Sticker Pack — Z": {
          cat: "Stickers",
          ...
          images: [
            `${_IMG_URL}/ZS/1_0008s_0000_Layer-16.png`,
            `${_IMG_URL}/ZS/1_0008s_0001_Layer-17.png`,
            `${_IMG_URL}/ZS/1_0008s_0002_Layer-18.png`,
            `${_IMG_URL}/ZS/1_0008s_0003_Layer-19.png`,
          ],
        },
        "Notebook — S": {
          cat: "Notebooks",
          ...
          images: [
            `${_IMG_URL}/SB/1_0003s_0000_Layer-39.png`,
            `${_IMG_URL}/SB/1_0003s_0001_Layer-40.png`,
            `${_IMG_URL}/SB/1_0004s_0000_Layer-37.png`,
          ],
        },
        "Notebook — Z": {
          cat: "Notebooks",
          ...
          images: [
            `${_IMG_URL}/ZB/1_0009s_0000_Layer-3.png`,
            `${_IMG_URL}/ZB/1_0009s_0001_Layer-2.png`,
            `${_IMG_URL}/ZB/1_0009s_0002_Layer-4.png`,
            `${_IMG_URL}/ZB/1_0009s_0003_Layer-5.png`,
            `${_IMG_URL}/ZB/1_0009s_0004_Layer-6.png`,
            `${_IMG_URL}/ZB/1_0009s_0005_Layer-7.png`,
          ],
        },
        "T-Shirt — B": {
          cat: "T-Shirts",
          ...
          images: [
            `${_IMG_URL}/BT/11_0002s_0000_Layer-63.png`,
            `${_IMG_URL}/BT/11_0002s_0001_Layer-64.png`,
          ],
        },
        "T-Shirt — R": {
          cat: "T-Shirts",
          ...
          images: [
            `${_IMG_URL}/RT/111_0001s_0000_Layer-71.png`,
            `${_IMG_URL}/RT/111_0001s_0001_Layer-72.png`,
            `${_IMG_URL}/RT/111_0001s_0002_Layer-73.png`,
          ],
        },
        "Stainless Flask — B": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/BF/11_0004s_0000_Layer-57.png`,
          ],
        },
        "Stainless Flask — R": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/RF/111_0002s_0000_Layer-69.png`,
          ],
        },
        "Tote Bag — B": {
          cat: "Tote Bags",
          ...
          images: [
            `${_IMG_URL}/BTB/11_0003s_0000_Layer-59.png`,
            `${_IMG_URL}/BTB/11_0003s_0001_Layer-60.png`,
            `${_IMG_URL}/BTB/11_0003s_0002_Layer-61.png`,
          ],
        },
        "Tote Bag — R": {
          cat: "Tote Bags",
          ...
          images: [
            `${_IMG_URL}/RTB/111_0000s_0000_Layer-74.png`,
          ],
        },
        "Notebook — B": {
          cat: "Notebooks",
          ...
          images: [
            `${_IMG_URL}/BB/11_0001s_0000_Layer-53.png`,
            `${_IMG_URL}/BB/11_0001s_0001_Layer-54.png`,
            `${_IMG_URL}/BB/11_0001s_0002_Layer-55.png`,
          ],
        },
        "Notebook — R": {
          cat: "Notebooks",
          ...
          images: [
            `${_IMG_URL}/RB/111_0003s_0000_Layer-66.png`,
            `${_IMG_URL}/RB/111_0003s_0001_Layer-67.png`,
            `${_IMG_URL}/RB/111_0003s_0002_Layer-68.png`,
          ],
        },
        "T-Shirt — K": {
          cat: "T-Shirts",
          ...
          images: [
            `${_IMG_URL}/KT/11_0001s_0000_Layer-83.png`,
            `${_IMG_URL}/KT/11_0001s_0001_Layer-84.png`,
            `${_IMG_URL}/KT/11_0001s_0002_Layer-85.png`,
          ],
        },
        "Stainless Flask — K": {
          cat: "Flasks",
          ...
          images: [
            `${_IMG_URL}/KF/11_0002s_0000_Layer-79.png`,
            `${_IMG_URL}/KF/11_0002s_0001_Layer-80.png`,
            `${_IMG_URL}/KF/11_0002s_0002_Layer-81.png`,
          ],
        },
        "Tote Bag — K": {
          cat: "Tote Bags",
          ...
          images: [
            `${_IMG_URL}/KTB/11_0000s_0000_Layer-86.png`,
          ],
        },
        "Notebook — K": {
          cat: "Notebooks",
          ...
          images: [
            `${_IMG_URL}/KB/11_0003s_0000_Layer-76.png`,
            `${_IMG_URL}/KB/11_0003s_0001_Layer-77.png`,
          ],
        },
      };
